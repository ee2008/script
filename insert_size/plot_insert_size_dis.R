...
dd400 <- subset(dd, dd$insert_size > 300 & dd$insert_size <= 1000)
...
p <- ggplot(dd_1000) + geom_line(aes(x = insert_size, y = pairs_total)) + ggtitle(paste0(sample,"( <100:",dd100_cent,"%; 100~200: ",dd200_cent,"%; 200~300: ",dd300_cent,"%; 300~1000: ",dd400_cent,"%; >1000: ",dd1000_cent,"%)"))
print (p)
dev.off()
